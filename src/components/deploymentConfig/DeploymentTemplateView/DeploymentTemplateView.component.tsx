...
export const CompareWithApprovalPendingAndDraft = ({
    ...
    return (
        <div data-testid="approval-draft-dropdown" className="flex dc__content-space w-100">
            <div className="flex left">
                {!readOnly ? <Edit className="icon-dim-16 mr-10" /> : <Eye data-testid="readonly-icon" />}
                {latestDraft ? (
                    <ReactSelect
    ...
    return (
        <div className="dc__transparent-div" onClick={onClose}>
            <div
                ...
                className="flex-col bcn-0 w-204 h-72 dc__position-abs dc__top-119 dc__border-radius-4-imp dc__left-405 dc__border dc__zi-20 config-toolbar-dropdown-shadow"
            >
