...
import { dynamicTabsData, fixedTabsData, mockedRemoveTabByIdentifier, tabsData } from '../__mocks__/DynamicTabs.mock'

describe('DynamicTabs component', () => {
    it('Component renders properly', () => {
        const { container } = render(<DynamicTabs tabs={[]} removeTabByIdentifier={jest.fn()} />, {
    ...
    it('Fixed tabs are rendered but no dynamic tabs', () => {
        const { container, getByText } = render(
            <DynamicTabs tabs={fixedTabsData} removeTabByIdentifier={jest.fn()} />,
            {
                wrapper: BrowserRouter,
            },
        )
    ...
    it('Dynamic tabs are rendered but no fixed tabs', () => {
        const { container, getByText } = render(
            <DynamicTabs tabs={dynamicTabsData} removeTabByIdentifier={jest.fn()} />,
            {
                wrapper: BrowserRouter,
            },
        )
    ...
    it('Fixed & Dynamic tabs are rendered properly', () => {
        const { container, getByText } = render(<DynamicTabs tabs={tabsData} removeTabByIdentifier={jest.fn()} />, {
            wrapper: BrowserRouter,
        })
    ...
    it('Dynamic tab close action works properly', () => {
        ...
        const { container, rerender } = render(
            <DynamicTabs tabs={_tabsData} removeTabByIdentifier={_removeTabByIdentifier} />,
            {
                wrapper: BrowserRouter,
            },
        )
        ...
        rerender(<DynamicTabs tabs={_tabsData} removeTabByIdentifier={_removeTabByIdentifier} />)
