...
export class DatePicker extends Component<DatePickerProps> {
    ...
    renderDatePresets() {
        ...
        return <div style={{ ...styless.PresetDateRangePicker_panel }}>
            {p.map(({ text, start, end }) => {
                const isSelected = start.isSame(this.props.startDate, "day") && end.isSame(this.props.endDate, "day");
                let buttonStyles = {
    ...
    render() {
        return <DateRangePicker focused
