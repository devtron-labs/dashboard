...
export default function GitCommitInfoGeneric({ showMaterialInfo, materialSourceType, materialSourceValue, commitInfo, selectCommitInfo }) {

    let _isWebhook = materialSourceType === SourceTypeMap.WEBHOOK;
        ...
        <>
            {
                ...
                <>
                    <div className="ml-16 mr-16 flex left" style={{ justifyContent: "space-between" }}>
                        ...
                        {toSelectCommitInfo ? <div className="material-history__select-text" >
                            {commitInfo.isSelected ? <Check className="align-right" /> : "Select"}
                        </div> : null}
                    </div>
                    <div className="material-history__text">Author: {commitInfo.author}</div>
                    <div className="material-history__text">Date: {commitInfo.date}</div>
                    <div className="material-history__text material-history-text--padded">{commitInfo.message}</div>
                </>
            }
            {
                _isWebhook &&
