...
export class DevtronSwitchItem extends Component<DevtronSwitchItemProps> {
    ...
    render() {
        return <SwitchContext.Consumer>
            {(value) => {
                return <>
                    <label className="radio">
                        <input type="checkbox" className="" name={value.name}
                            onChange={value.onChange} value={this.props.value}
...
export class DevtronSwitch extends Component<DevtronSwitchProps> {
    ...
    render() {
        return <div className="flex left radio-group">
