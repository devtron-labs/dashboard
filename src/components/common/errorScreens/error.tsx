...
export class ErrorScreenManager extends Component<{ code?: number, reload?: (...args) => any }> {

    getMessage() {
        switch (this.props.code) {
            case 400: return "Bad Request";
            case 401: return "Unauthorized";
            case 403: return <ErrorScreenNotAuthorized />;
...
export class ErrorScreenNotAuthorized extends Component<{}>{
    ...
    render() {
        return <EmptyState>
            ...
            <EmptyState.Title><h3 className="title">Not authorized</h3></EmptyState.Title>
            <EmptyState.Subtitle>
