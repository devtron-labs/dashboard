...
import { SideDocumentation } from './SideDocumentation'
...
export default function NavigationRoutes({ reloadVersionConfig }: Readonly<NavigationRoutesTypes>) {
    ...
    const [sideDocLink, setSideDocLink] = useState<string | null>(null)
    ...
    return (
        ...
        >
            <motion.main
                ...
                animate={{
                    gridTemplateColumns: `${!_isOnboardingPage ? '56px' : ''} 1fr ${sideDocLink ? `14px ${asideWidth}px` : '0px 0px'}`,
                }}
            ...
            >
                ...
                {serverMode && (
                    <>
                        ...
                        <SideDocumentation asideWidth={asideWidth} setAsideWidth={setAsideWidth} />
                    </>
                )}
            </motion.main>
        </MainContextProvider>
