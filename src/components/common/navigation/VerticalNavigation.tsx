...
interface VerticalNavigationProps extends RouteComponentProps<{}> {
...
export class VerticalNavigation extends Component<VerticalNavigationProps, VerticalNavigationState> {
