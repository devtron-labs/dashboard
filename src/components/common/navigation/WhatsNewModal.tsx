    ...
    render() {
        return <VisibleModal className="">
            <div className="bcn-0 br-8 modal__body modal__body--p-0 w-800-px">
                <div className="pt-14 pb-14 pl-20 pr-20 flexbox flex-justify">
                    <p className="fw-6 fs-20 m-0">What's new</p>
                    <button type="button" className="transparent" onClick={this.props.close}>
                        <Close className="icon-dim-20" />
                    </button>
                </div>
                {!this.props.isCurrentVersionLatest && <div className="bcb-1 pl-20 pr-20 version-info">
                    ...
                    <div className="whats-new-modal__left pt-8 pb-8 pl-20 pr-20">
                        {this.state.releases.map((release) => {
                            ...
                            return <p className={classes} onClick={() => { this.setState({ selected: release }) }}>
                                ...
                                {!this.props.isCurrentVersionLatest && this.props.currentVersion === release.tag_name ? " (Current)" : ""}
                            </p>
                        })}
                    </div>
