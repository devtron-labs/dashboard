...
const RadioGroup: React.FC<RadioGroupInterface> & RadioGroupComposition = React.memo(function RadioGroup({ name, onChange, children, className = "", initialTab, disabled=false }) {
