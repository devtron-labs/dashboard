...
export class DeleteCVEModal extends Component<DeleteCVEModalProps, any> {
    ...
    renderHeader() {
        return <div className="modal__header">
            ...
            <button type="button" className="transparent " onClick={this.props.closeDelete}>
    ...
    render() {
        return <VisibleModal className="">
            <div className="modal__body modal__body--no-padding">
                {this.renderHeader()}
                <p className="mb-20">This policy will not be deleted at below levels as policy for this CVE has been defined separately at below levels.</p>
                <ul>
