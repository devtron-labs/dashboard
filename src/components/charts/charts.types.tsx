...
export type ChartsProps = RouteComponentProps<any>

export type DeployedChartProps = RouteComponentProps<{}>
...
export type ChartValuesProps = RouteComponentProps<{ chartId: string; chartValueId?: string }>
...
export type DiscoverChartsContainerProps = RouteComponentProps<{}>
