...
export function getClusterList(): Promise<any> {
    ...
    //          { "id": 10, "cluster_name": "delhivery-fms-test", "server_url": "https://delhivery-fms-dev.devtron.info", "prometheus_url": "http://www.google.com", "active": true, "defaultClusterComponent": null, "agentInstallationStage": 0 }, 
    //          { "id": 1, "cluster_name": "default_cluster", "server_url": "https://kubernetes.default.svc", "prometheus_url": "http://demo.devtron.info:32080/prometheus", "active": true, "defaultClusterComponent": null, "agentInstallationStage": 0 }, 
