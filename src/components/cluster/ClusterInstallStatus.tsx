    ...
    render() {
        ...
        if (this.props.agentInstallationStage === 0) {
            return <div className={`${classes} cluster-create-status--not-triggered`}>
                ...
                <p className="cluster-create-status__title mb-0">Install devtron agent on env: {this.props.envName}.</p>
            ...
            return <div className={`${classes} cluster-create-status--installing`}>
                ...
                <p className="cluster-create-status__title mb-0">Devtron agent running on env: {this.props.envName}.</p>
            ...
            return <div className={`${classes} cluster-create-status--failed`}>
                ...
                <p className="cluster-create-status__title mb-0">Devtron agent installation failed on env: {this.props.envName}.</p>
