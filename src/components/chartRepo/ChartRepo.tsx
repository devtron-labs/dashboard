...
export default function ChartRepo() {
    ...
    return (
        <section className="global-configuration__component">
            ...
            <div className="form__subtitle float-left bold">Repositories({result.result.length})</div>
            <Tippy className="default-tt" arrow={false} placement="top" content="Refetch chart from repositories">
            <div className="form__subtitle float-right"><a rel="noreferrer noopener" target="_blank" className="learn-more__href cursor" onClick={refetchCharts}><span>
                <svg width="16" height="16" viewBox="2 -2 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M11.0105 6.23225H14.0105V3.23225" stroke="#0066CC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M4.11096 4.11091C4.62168 3.60019 5.228 3.19506 5.89529 2.91866C6.56258 2.64226 7.27778 2.5 8.00005 2.5C8.72232 2.5 9.43752 2.64226 10.1048 2.91866C10.7721 3.19506 11.3784 3.60019 11.8891 4.11091L14.0105 6.23223" stroke="#0066CC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <span>Refetch Charts</span></a></div>
            </Tippy>
