        ...
        <VisibleModal className="transition-effect">
            <div className="modal__body" style={{ width: '600px' }}>
                <div className="flexbox mb-20">
                    ...
                    <div>
                        <div className="fw-6 fs-16" data-testid="cd-success-modal">{successTitle}</div>
                        <div className="fs-13">What do you want to do next?</div>
                    </div>
                </div>
                <NavLink to={`${URLS.APP}/${appId}/${URLS.APP_TRIGGER}`} data-testid="go-to-build-deploy-link" className="cb-5 dc__no-decor">
