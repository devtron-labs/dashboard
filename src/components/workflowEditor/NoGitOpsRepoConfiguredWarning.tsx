    ...
    return (
        ...
        <div className="confirmation-dialog__body ">
            ...
            <div className="flex left column ">
                ...
                <p className="fs-14 fw-4 cn-9">You're making changes based on old GitOps configurations. Please reload the page to continue.</p>
            </div>
            <div className="flex right confirmation-dialog__button-group">
                <button type="button" className="cta cancel sso__warn-button" onClick={reload}>
                    Reload
                </button>
            </div>
        </div>
