    ...
    render() {
        ...
        return <>
            <div className="cursor cn-9 pt-12 pb-12 fw-6 flex" onClick={this.props.toggleAppChecklist}>
                <p className="m-0 fs-14">To deploy custom application ({this.props.appStageCompleted}/6 completed)</p>
            ...
            {!this.props.isAppCollapsed ? <div className="fs-13">
                {this.props.showDivider && <hr className="divider mt-0 mb-0" />}
                ...
                <NavLink to={`${URLS.GLOBAL_CONFIG_PROJECT}`} className="no-decor  mt-8 flex left" style={{ ['color']: project ? `#767d84` : `#0066cc` }}>
