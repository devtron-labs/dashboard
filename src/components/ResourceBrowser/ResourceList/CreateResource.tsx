        ...
        if (showCodeEditorView) {
            return (
                <div className="dc__border-top flex right p-16">
                    ...
                    <button className="cta h-36 lh-36" disabled={loader || !resourceYAML} onClick={onSave} data-testid="create-kubernetes-resource-button">
            ...
            return (
                <div className="dc__border-top flexbox dc__content-space right p-16">
                    ...
                    <button className="cta cancel h-36 lh-36 mr-12" type="button" onClick={onClose} data-testid="close-after-resource-creation">
