...
import { ApiResourceGroupType } from '@devtron-labs/devtron-fe-common-lib'
    ...
    it('Component renders properly', () => {
        const { container, getByText } = render(
            <SidebarComponentWithProvider
                k8SObjectMap={{} as any}
                selectedResource={{} as ApiResourceGroupType}
                handleGroupHeadingClick={vi.fn}
                setSelectedResource={vi.fn()}
                updateResourceSelectionData={vi.fn}
