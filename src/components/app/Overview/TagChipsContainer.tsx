...
export default function TagChipsContainer({ labelTags, onAddTagButtonClick, resourceName }: TagChipsContainerType) {
    return (
            ...
            {labelTags.length > 0 ? (
                labelTags.map((tag, index) => (
                    <div key={tag.id} className="display-grid grid-auto-flow-column">
                        <div
                            className={`flex bc-n50 cn-9 fw-4 fs-12 lh-16 en-2 bw-1 pr-6 pl-6 pb-2 pt-2 dc__ellipsis-right ${
