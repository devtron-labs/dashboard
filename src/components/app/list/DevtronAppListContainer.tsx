...
const DevtronAppList = ({
    ...
    const renderAppList = () => (
        <div className="app-list" data-testid="app-list-container">
            <div
                className={`app-list__header ${!isArgoInstalled ? 'app-list__header--argo-not-configured' : ''} dc__position-sticky dc__top-47`}
            >
                        ...
                        <React.Fragment key={app.id}>
                            {!expandedState.expandedRow[app.id] ? (
                                <Link
                                    ...
                                    className={`app-list__row ${!isArgoInstalled ? 'app-list__row--argo-not-configured' : ''} ${len ? 'dc__hover-icon' : ''}`}
