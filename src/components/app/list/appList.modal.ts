import { getEnvironmentListMin, getTeamListMin, getDockerRegistryStatus } from '../../../services/service';
import { handleUTCTime } from '../../common';
import { Environment } from './types';
import moment from 'moment';

export const getInitState = (appListPayload): Promise<any> => {
    return Promise.all([getTeamListMin(), getEnvironmentListMin(), getDockerRegistryStatus()]).then(([teams, environments, dockerRegistryRes]) => {
        let filterApplied = {
        ...
        let parsedResponse = {
            ...
            isDockerRegistryEmpty: !(dockerRegistryRes.result),
        }
