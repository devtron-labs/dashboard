            ...
            <div className="w-100">
                ...
                {manifest?.status.conditions.map((condition) => {
                    return <div key={condition.type} className="w-100" style={{ display: "grid", gridTemplateColumns: '1fr 1fr 1fr 1fr 1fr', gap: "16px", borderBottom: "bcn-7" }}>
                        ...
                        <div className="pt-3 pb-3 cn-0">{condition.lastTransitionTime}</div>
                        <div className="pt-3 pb-3 cn-0">{condition?.message}</div>
                        <div className="pt-3 pb-3 cn-0">{condition?.reason}</div>
                    </div>
                })}
            </div>
        </div>
