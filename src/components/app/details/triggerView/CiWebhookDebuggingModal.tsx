        ...
        return (
            <div style={{ height: 'calc(100vh - 75px' }} className="bcn-0 pl-16 mt-20">
                <div style={{ background: '#f2f4f7' }}>
                    ...
                    <div
                        className={`${
                            expandIncomingPayload ? `expand-incoming-payload` : `collapsed-incoming-payload`
                        } cn-9 fs-13 pl-12 pr-12 pb-20`}
                ...
                <div>
                    ...
                    <div className="cn-9 fw-6 fs-14 flex left">
                        ...
                        <button
                            type="button"
                            className="mr-20 dc__transparent dc__align-right"
                            onClick={() => onEditShowEditableCiModal(ciPipelineMaterialId, workflowId)}
                        >
                            <Edit className=" icon-dim-24" />
                        </button>
                    </div>
