...
export class Workflow extends Component<WorkflowProps> {
    ...
    render() {
        return <div className="workflow workflow--trigger mb-20" style={{ minWidth: `${this.props.width}px` }}>
