                    ...
                    <section className="graph-modal flexbox w-100">
                        <div className="graph-modal__left">
                            {this.props.infraMetrics && (
                                <div
                                    className={`app-details-graph pt-4 cursor ${
                                        this.state.mainChartName === 'cpu' ? 'app-details-graph__iframe--selected' : ''
                                    }`}
                            ...
                            {this.props.infraMetrics && (
                                <div
                                    className={`app-details-graph pt-4 cursor  ${
                                        this.state.mainChartName === 'ram' ? 'app-details-graph__iframe--selected' : ''
                                    }`}
                            ...
                            {this.props.appMetrics && (
                                <div
                                    className={`app-details-graph pt-4 cursor  ${
                                        this.state.mainChartName?.toLowerCase() === ChartType.Status &&
                                        this.state.statusCode === 'Throughput'
                                            ? 'app-details-graph__iframe--selected'
                                            : ''
                                    }`}
                            ...
                            {this.props.appMetrics && (
                                <div
                                    className={`app-details-graph pt-4 cursor ${
                                        this.state.mainChartName === ChartType.Status &&
                                        this.state.statusCode?.toLowerCase().startsWith('2')
                                            ? 'app-details-graph__iframe--selected'
                                            : ''
                                    }`}
                            ...
                            {this.props.appMetrics && (
                                <div
                                    className={`app-details-graph pt-4 cursor ${
                                        this.state.mainChartName === ChartType.Status &&
                                        this.state.statusCode?.toLowerCase().startsWith('4')
                                            ? 'app-details-graph__iframe--selected'
                                            : ''
                                    }`}
                            ...
                            {this.props.appMetrics && (
                                <div
                                    className={`app-details-graph pt-4 cursor ${
                                        this.state.mainChartName === ChartType.Status &&
                                        this.state.statusCode?.toLowerCase().startsWith('5')
                                            ? 'app-details-graph__iframe--selected'
                                            : ''
                                    }`}
                            ...
                            {this.props.appMetrics && (
                                <div
                                    className={`app-details-graph pt-4 cursor ${
                                        this.state.mainChartName === ChartType.Latency
                                            ? 'app-details-graph__iframe--selected'
                                            : ''
                                    }`}
