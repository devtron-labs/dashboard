            ...
            <div>
                <div className="ml-24 mr-24 mt-10" >
                    ...
                    <div>
                        ...
                        <div className="flex left ml-38">
                            <div className="line" />
                            {configApplyStep === "error" ? <div className="w-100 cr-5 bcr-1 ml-24 p-12 br-4"><div className="cn-9 fw-6">Error Message:</div>
                                {appDetails?.deploymentStatus?.configApplyStep?.errorMessage}</div> : null}
                        </div>
                    </div>
