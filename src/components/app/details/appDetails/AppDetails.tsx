...
export default function AppDetail() {
    ...
    const isVirtualEnvironment = useRef(false)
    ...
    async function callAppDetailsAPI(fetchExternalLinks?: boolean) {
        appDetailsAPI(params.appId, params.envId, 25000)
            .then((response) => {
                ...
                isVirtualEnvironment.current = response.result?.isVirtualEnvironment
        ...
        <React.Fragment>
            <div className="w-100 pt-16 pr-20 pb-16 pl-20">
                <SourceInfo
                    ...
                    isVirtualEnvironment={isVirtualEnvironment.current}
                />
            </div>
            <SyncErrorComponent
            ...
            {!loadingDetails && !loadingResourceTree && !appDetails?.deploymentAppDeleteRequest && (
                <>
                    ...
                    />
                    {environment && !isVirtualEnvironment.current && (
                        <AppMetrics
