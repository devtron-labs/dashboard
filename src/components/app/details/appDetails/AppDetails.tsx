  ...
  useEffect(() => {
    ...
    return <React.Fragment>
         <div className="w-100 pt-16 pr-20 pb-16 pl-20">
                    ...
                    {/* <SyncError appStreamData={streamData} showApplicationDetailedModal={showApplicationDetailedModal}/> */}
...
// const SyncError: React.FC<{ appStreamData: AppStreamData, showApplicationDetailedModal }> = ({ appStreamData, showApplicationDetailedModal }) => {
