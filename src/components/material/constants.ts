export const INCLUDE_EXCLUDE_TIPPY = {
    lineOne: "Assign exclude rules to prevent builds from commits having changes only in certain files of your repository.",
    lineTwo: "Commits having changes only in excluded files or folders, will not be eligible for build.",
    lineThree: "For example, an exclude rule could be set to ignore changes made to README.md or other documentation files.",
    lineFour: "If building a service from a monorepo, path exclude rules could be set to ignore changes to folders other than a specific folder.",
}

export const LEARN_HOW = {
    infoList: {
        lineOne: {
            partOne: "Use",
            partTwo: "!",
