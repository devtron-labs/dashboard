        ...
        return <section className="git-page">
            ...
            <div className="gitops login__sso-wrapper  pr-20">
                <div className="login__sso-flex">
                    <div>
                        <label className="tertiary-tab__radio ">
                            <input type="radio" name="status" value="gitlab" checked={this.state.githost === "gitlab"} onClick={this.handleGitopsTab} />
                    ...
                    <div>
                        <label className="tertiary-tab__radio ">
                            <input type="radio" name="status" value="github" checked={this.state.githost === "github"} onClick={this.handleGitopsTab} />
                            <span className="tertiary-tab sso-icons">
                ...
                <div className="flex column left top  pl-20">
                    <div className="gitops__id fs-13 pb-6">Git host*</div>
                ...
                <div className="flex column left top pt-16 pl-20 pb-6">
                    <div className="gitops__id fs-13 ">GitLab organisation ID*</div>
                ...
                <form className="pl-20 pr-20">
                    <div className=" form__row--two-third pt-16 gitops__id fs-13 ">
                        <CustomInput value={this.state.form.username} onChange={(event) => this.handleChange(event, 'username')} name="Enter username" error={""} label="GitLab username*" labelClassName="gitops__id fs-13" />
                        <ProtectedInput value={this.state.form.token} onChange={(event) => this.handleChange(event, 'token')} name="Enter token" error={""} label="GitLab token*" labelClassName="gitops__id fs-13" />
                    </div>
