...
export class NotificationTab extends Component<any, NotificationTabState> {
    ...
    onOpenEditNotficationMenu(): void {
        let allSelectedRows = this.state.notificationList
    ...
    renderDeleteDialog() {
        if (this.state.showDeleteDialog) {
            let n = this.state.singleDeletedId
    ...
    renderEmptyState() {
        return (
            <EmptyState>
                ...
                <EmptyState.Subtitle>
                    Receive alerts when a pipeline triggers, completes successfully or fails.
                </EmptyState.Subtitle>
                <div
            ...
            return (
                <div className="dc__block mt-20 mb-20">
                    <Tippy placement="top" content="Delete">
                        <Delete className="icon-dim-24 mr-20 notification-tab__option" onClick={this.showDeleteModal} />
                    </Tippy>
                    <PopupMenu
    ...
    remderModifyRecipients() {
        if (this.state.showModifyRecipientsModal) {
            let allCandidates = this.state.notificationList
                .filter((row) => row.isSelected)
                .map((row) => {
