...
function ValuesComponent({ appId, _init }: { appId: string, _init: () => void }) {
    ...
    return (
        <div>
            {!installedConfig ? (
                ...
                <ChartValuesView appId={appId} installedConfigFromParent={installedConfig} appDetails={appDetails} _init={_init} />
            )}
        </div>
    )
}
