...
function CurrentSyncStatus({ status, loadingResourceTree }: CurrentSyncStatusType): JSX.Element {
        ...
        return (
            <>
                <div className={`f-${status.toLowerCase()} dc__capitalize fw-6 fs-14 flex left`}>
                    ...
                    <figure className={`${status.toLowerCase()} dc__app-summary__icon ml-8 icon-dim-20`}></figure>
                </div>
                <div>
