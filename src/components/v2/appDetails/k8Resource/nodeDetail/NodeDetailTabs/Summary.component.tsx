    ...
    return (
        <div className="p-20 bg__primary flex-grow-1" style={{ gridColumn: '1 / span 2', overflowY: 'scroll' }}>
            <div className="w-100" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                <div className="summary-view__card pt-16 pb-16 pl-16 pr-16 br-4">
                    ...
                    <div className="w-100" style={{ display: 'grid', gridTemplateColumns: '100px 1fr', gap: '16px' }}>
                        ...
                        <div className="pt-6" style={{ color: '#62aceb' }}>
            ...
            {manifest?.spec.containers?.map((container) => {
                return (
                    <div className="summary-view__card mt-12 flex left top column pt-16 pl-16 pr-16 br-4">
                        <div className=" mb-8 fw-6 fs-14">{container.name}</div>
                        <div className="  w-100">
                            <div
                                className=""
                                style={{ display: 'grid', gridTemplateColumns: '100px 1fr', gap: '16px' }}
                            >
