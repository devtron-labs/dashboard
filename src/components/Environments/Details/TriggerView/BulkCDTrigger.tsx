...
export default function BulkCDTrigger({ appId, envId, closePopup, isLoading }: BulkCDTriggerType) {
    ...
    const renderHeaderSection = (): JSX.Element => {
        return (
            <div className="flex flex-align-center flex-justify dc__border-bottom bcn-0 pt-17 pr-20 pb-17 pl-20">
                <h2 className="fs-16 fw-6 lh-1-43 m-0 title-padding">Deploy to</h2>
