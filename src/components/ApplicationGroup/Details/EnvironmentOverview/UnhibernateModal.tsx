import { MODAL_TYPE, Progressing, VisibleModal, stopPropagation } from '@devtron-labs/devtron-fe-common-lib'
...
export const UnhibernateModal = ({
    ...
    const unhibernateApps = (e) => {
        ...
        manageApps(selectedAppIds, appDetailsList, Number(envId), envName, 'unhibernate', httpProtocol).then((res) => {
