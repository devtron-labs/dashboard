...
export default class LinkedCIPipelineView extends Component<CIPipelineProps, CIPipelineState> {
    ...
    deletePipeline() {
        deleteCIPipeline(this.state.form, this.state.ciPipeline, this.state.form.materials, +this.props.match.params.appId, +this.props.match.params.workflowId, this.state.form.isExternal, this.state.form.webhookConditionList).then((response) => {
            if (response) {
