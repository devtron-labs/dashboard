...
import { VisibleModal, ButtonWithLoader } from '../common';
        ...
        return <VisibleModal className="">
            <div className="modal__body br-0 modal__body--w-800 modal__body--p-0">
                ...
                <div className="flex left mb-12">
                    {/* <div className={"cursor br-4 pt-8 pb-8 pl-16 pr-16 ml-20 cn-7 fs-14 fw-6"}
                        style={{ border: "1px solid #d0d4d9", width: "155px" }}
                        onClick={this.props.renderAdvanceCI}>
                        Advanced options
                    </div> */}
