...
function Form({dockerRegistries, sourceConfig, ciConfig, reload, appId }){
    ...
    return (
        <div className="form__app-compose">
            ...
            <span><a rel="noreferrer noopener" href="https://docs.devtron.ai/docs/reference/creating-application/docker-configuration/"> Learn more about Docker Build Config</a> </span></p>
