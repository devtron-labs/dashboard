    ...
    if (
        ...
        ciConfigDiffValues.push(
            ...
            },
            {
                ...
                changeBGColor:
                    globalBuildContextGitMaterialItem?.checkoutPath + (globalBuildContext ? globalBuildContext : '') !==
                    currentBuildContextGitMaterialItem?.checkoutPath + (currentBuildContext ? currentBuildContext : ''),
                baseValue:
                    globalBuildContextGitMaterialItem?.checkoutPath + (globalBuildContext ? globalBuildContext : ''),
                overridenValue:
                    currentBuildContextGitMaterialItem?.checkoutPath + (currentBuildContext ? currentBuildContext : ''),
