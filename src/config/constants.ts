...
export const PATTERNS = {
    ...
    CUSTOM_TAG: /^({[xX]}){1}[A-Za-z0-9,.-]*[A-Za-z0-9]+$|^[A-Za-z0-9][A-Za-z0-9,.-]*({[xX]}){1}[A-Za-z0-9,.-]*[A-Za-z0-9]+$|^[A-Za-z0-9][A-Za-z0-9,.-]*({[xX]}){1}$/ //Allowed: Alphanumeric characters, including (_) (.) (-) {x} {X} but cannot begin or end with (.) or (-)
}
