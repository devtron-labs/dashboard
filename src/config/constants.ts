...
export const DOCUMENTATION = {
    ...
    APP_CREATE: 'https://docs.devtron.ai/devtron/v/v0.5/usage/applications/create-application',
    APP_CREATE_MATERIAL: 'https://docs.devtron.ai/devtron/v/v0.5/usage/applications/creating-application/git-material',
    APP_CREATE_CI_CONFIG: 'https://docs.devtron.ai/devtron/v/v0.5/usage/applications/creating-application/docker-build-configuration',
    APP_CREATE_DEPLOYMENT_TEMPLATE: 'https://docs.devtron.ai/devtron/v/v0.5/usage/applications/creating-application/deployment-template/rollout-deployment',
    APP_CREATE_CONFIG_MAP: 'https://docs.devtron.ai/devtron/v/v0.5/usage/applications/creating-application/config-maps',
    APP_CREATE_SECRET: 'https://docs.devtron.ai/devtron/v/v0.5/usage/applications/creating-application/secrets',
    APP_CREATE_WORKFLOW: 'https://docs.devtron.ai/devtron/v/v0.5/usage/applications/creating-application/workflow',
    APP_CREATE_ENVIRONMENT_OVERRIDE: 'https://docs.devtron.ai/devtron/v/v0.5/usage/applications/creating-application/environment-overrides',
    BULK_UPDATE: 'https://docs.devtron.ai/devtron/v/v0.5/usage/bulk-update',
    CHART_DEPLOY: 'https://docs.devtron.ai/devtron/v/v0.5/usage/deploy-chart',
    CHART_LIST: 'https://docs.devtron.ai/devtron/v/v0.5/usage/deploy-chart/overview-of-charts',
    SECURITY: 'https://docs.devtron.ai/devtron/v/v0.5/usage/security-features',
    GLOBAL_CONFIG_GITOPS: 'https://docs.devtron.ai/devtron/v/v0.5/getting-started/global-configurations/gitops',
    GLOBAL_CONFIG_GIT: 'https://docs.devtron.ai/devtron/v/v0.5/getting-started/global-configurations/git-accountss',
    GLOBAL_CONFIG_DOCKER: 'https://docs.devtron.ai/devtron/v/v0.5/getting-started/global-configurations/docker-registries',
    GLOBAL_CONFIG_CLUSTER: 'https://docs.devtron.ai/devtron/v/v0.5/getting-started/global-configurations/cluster-and-environments',
    GLOBAL_CONFIG_CHART: 'https://docs.devtron.ai/devtron/v/v0.5/getting-started/global-configurations/chart-repo',
    GLOBAL_CONFIG_NOTIFICATION: 'https://docs.devtron.ai/devtron/v/v0.5/getting-started/global-configurations/manage-notification',
    GLOBAL_CONFIG_PROJECT: 'https://docs.devtron.ai/devtron/v/v0.5/getting-started/global-configurations/projects',
    GLOBAL_CONFIG_SSO: 'https://docs.devtron.ai/devtron/v/v0.5/getting-started/global-configurations/sso-login',
    GLOBAL_CONFIG_USER: 'https://docs.devtron.ai/devtron/v/v0.5/getting-started/global-configurations/authorization/user-access',
    GLOBAL_CONFIG_GROUPS: 'https://docs.devtron.ai/devtron/v/v0.5/getting-started/global-configurations/authorization/permission-groups',
    HYPERION: 'https://docs.devtron.ai/#hyperion',
    BUILD_STAGE: 'https://docs.devtron.ai/devtron/v/v0.5/usage/applications/creating-application/ci-pipeline#build-stage',
    PRE_POST_BUILD_STAGE:
        'https://docs.devtron.ai/devtron/v/v0.5/usage/applications/creating-application/ci-pipeline/ci-build-pre-post-plugins',
    CUSTOM_CHART: 'https://docs.devtron.ai/devtron/v/v0.5/getting-started/global-configurations/custom-charts',
    CUSTOM_CHART_PRE_REQUISITES:
        'https://docs.devtron.ai/devtron/v/v0.5/getting-started/global-configurations/custom-charts#prerequisites',
    ADMIN_PASSWORD: 'https://docs.devtron.ai/devtron/v/v0.5/getting-started/install/install-devtron#devtron-admin-credentials',
    CUSTOM_VALUES: 'https://docs.devtron.ai/devtron/v/v0.5/usage/deploy-chart/overview-of-charts#custom-values',
    EXTERNAL_LINKS: 'https://docs.devtron.ai/devtron/v/v0.5/getting-started/global-configurations/external-links',
    GLOBAL_CONFIG_GIT_ACCESS_LINK: 'https://docs.devtron.ai/devtron/v/v0.5/getting-started/global-configurations/gitops#4.-git-access-credential',
    DEVTRON_UPGRADE: 'https://docs.devtron.ai/devtron/v/v0.5/getting-started/upgrade'
}
