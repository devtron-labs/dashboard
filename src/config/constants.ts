...
export const HEADER_TEXT = {
    API_TOKEN: {
        ...
        docLink: getDocumentationUrl(DOCUMENTATION.GLOBAL_CONFIG_API_TOKEN),
    },
    CHART_REPOSITORY: {
        title: 'Chart Repository',
        description: 'Manage your organization’s chart repositories.',
        docLink: getDocumentationUrl(DOCUMENTATION.GLOBAL_CONFIG_CHART),
    },
    HOST_URL: {
        title: 'Host URL',
        description: 'Host URL is the domain address at which your devtron dashboard can be reached.',
        docLink: getDocumentationUrl(DOCUMENTATION.GLOBAL_CONFIG_HOST_URL),
    },
    GITOPS: {
        title: 'GitOps',
        description: 'Devtron uses GitOps configuration to store kubernetes configuration files of applications.',
        docLink: getDocumentationUrl(DOCUMENTATION.GLOBAL_CONFIG_GITOPS),
    },
    GIT_ACCOUNTS: {
        title: 'Git Accounts',
        description: 'Manage your organization’s git accounts.',
        docLink: getDocumentationUrl(DOCUMENTATION.GLOBAL_CONFIG_GIT),
    },
    NOTIFICATIONS: {
        title: 'Notifications',
    ...
    PROJECTS: {
        ...
        docLink: getDocumentationUrl(DOCUMENTATION.GLOBAL_CONFIG_PROJECT),
    },
    SSO_LOGIN: {
    ...
    SCOPED_VARIABLES: {
        ...
        docLink: getDocumentationUrl(DOCUMENTATION.GLOBAL_CONFIG_SCOPED_VARIABLES),
    },
}
