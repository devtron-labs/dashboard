...
export const DOCUMENTATION = {
    ...
    APP_CREATE: `${DOCUMENTATION_HOME_PAGE}/usage/applications/create-application`,
    APP_CREATE_MATERIAL: `${DOCUMENTATION_HOME_PAGE}/usage/applications/creating-application/git-material`,
    APP_CREATE_CI_CONFIG: `${DOCUMENTATION_HOME_PAGE}/usage/applications/creating-application/docker-build-configuration`,
    APP_ROLLOUT_DEPLOYMENT_TEMPLATE: `${DOCUMENTATION_HOME_PAGE}/usage/applications/creating-application/deployment-template/rollout-deployment`,
    APP_DEPLOYMENT_TEMPLATE: `${DOCUMENTATION_HOME_PAGE}/usage/applications/creating-application/deployment-template`,
    APP_CREATE_CONFIG_MAP: `${DOCUMENTATION_HOME_PAGE}/usage/applications/creating-application/config-maps`,
    APP_CREATE_SECRET: `${DOCUMENTATION_HOME_PAGE}/usage/applications/creating-application/secrets`,
    APP_CREATE_WORKFLOW: `${DOCUMENTATION_HOME_PAGE}/usage/applications/creating-application/workflow`,
    APP_CREATE_ENVIRONMENT_OVERRIDE: `${DOCUMENTATION_HOME_PAGE}/usage/applications/creating-application/environment-overrides`,
    BULK_UPDATE: `${DOCUMENTATION_HOME_PAGE}/usage/bulk-update`,
    CHART_DEPLOY: `${DOCUMENTATION_HOME_PAGE}/usage/deploy-chart`,
    CHART_GROUP: `${DOCUMENTATION_HOME_PAGE}/usage/deploy-chart/chart-group`,
    CHART_LIST: `${DOCUMENTATION_HOME_PAGE}/usage/deploy-chart/overview-of-charts`,
    CUSTOM_VALUES: `${DOCUMENTATION_HOME_PAGE}/usage/deploy-chart/overview-of-charts#custom-values`,
    SECURITY: `${DOCUMENTATION_HOME_PAGE}/usage/security-features`,
    GLOBAL_CONFIG_GITOPS: `${DOCUMENTATION_HOME_PAGE}/getting-started/global-configurations/gitops`,
    GLOBAL_CONFIG_GIT: `${DOCUMENTATION_HOME_PAGE}/getting-started/global-configurations/git-accounts`,
    GLOBAL_CONFIG_DOCKER: `${DOCUMENTATION_HOME_PAGE}/getting-started/global-configurations/docker-registries`,
    GLOBAL_CONFIG_CLUSTER: `${DOCUMENTATION_HOME_PAGE}/getting-started/global-configurations/cluster-and-environments`,
    GLOBAL_CONFIG_CHART: `${DOCUMENTATION_HOME_PAGE}/getting-started/global-configurations/chart-repo`,
    GLOBAL_CONFIG_NOTIFICATION: `${DOCUMENTATION_HOME_PAGE}/getting-started/global-configurations/manage-notification`,
    GLOBAL_CONFIG_PROJECT: `${DOCUMENTATION_HOME_PAGE}/getting-started/global-configurations/projects`,
    GLOBAL_CONFIG_SSO: `${DOCUMENTATION_HOME_PAGE}/getting-started/global-configurations/sso-login`,
    GLOBAL_CONFIG_USER: `${DOCUMENTATION_HOME_PAGE}/getting-started/global-configurations/authorization/user-access`,
    GLOBAL_CONFIG_GROUPS: `${DOCUMENTATION_HOME_PAGE}/getting-started/global-configurations/authorization/permission-groups`,
    HYPERION: `${DOCUMENTATION_HOME_PAGE}/#hyperion`,
    BUILD_STAGE: `${DOCUMENTATION_HOME_PAGE}/usage/applications/creating-application/ci-pipeline#build-stage`,
    PRE_POST_BUILD_STAGE: `${DOCUMENTATION_HOME_PAGE}/usage/applications/creating-application/ci-pipeline/ci-build-pre-post-plugins`,
    CUSTOM_CHART: `${DOCUMENTATION_HOME_PAGE}/getting-started/global-configurations/custom-charts`,
    CUSTOM_CHART_PRE_REQUISITES: `${DOCUMENTATION_HOME_PAGE}/getting-started/global-configurations/custom-charts#prerequisites`,
    ADMIN_PASSWORD: `${DOCUMENTATION_HOME_PAGE}/getting-started/install/install-devtron#devtron-admin-credentials`,
    EXTERNAL_LINKS: `${DOCUMENTATION_HOME_PAGE}/getting-started/global-configurations/external-links`,
    GLOBAL_CONFIG_GIT_ACCESS_LINK: `${DOCUMENTATION_HOME_PAGE}/getting-started/global-configurations/gitops#4.-git-access-credential`,
    DEVTRON_UPGRADE: `${DOCUMENTATION_HOME_PAGE}/getting-started/upgrade`,
    APP_METRICS: `${DOCUMENTATION_HOME_PAGE}/usage/applications/app-details/app-metrics`,
    EXTERNAL_SECRET: `${DOCUMENTATION_HOME_PAGE}/usage/applications/creating-application/secrets#external-secrets`,
    BLOB_STORAGE: `${DOCUMENTATION_HOME_PAGE}/getting-started/install/installation-configuration#configuration-of-blob-storage`,
    ...
    DEPLOYMENT: `${DOCUMENTATION_HOME_PAGE}/usage/applications/creating-application/deployment-template/deployment`,
    WEBHOOK_API_TOKEN: `${DOCUMENTATION_HOME_PAGE}/getting-started/global-configurations/authorization/api-tokens`,
    WEBHOOK_CI: `${DOCUMENTATION_HOME_PAGE}/usage/applications/creating-application/ci-pipeline#3.-deploy-image-from-external-service`,
}
