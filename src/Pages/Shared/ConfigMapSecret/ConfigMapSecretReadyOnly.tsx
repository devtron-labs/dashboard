import { CodeEditor, hasHashiOrAWS, MODES, Progressing } from '@devtron-labs/devtron-fe-common-lib'
...
export const ConfigMapSecretReadyOnly = ({
    ...
    return areScopeVariablesResolving ? (
        ...
        <div
            className={`bg__primary flex-grow-1 flexbox-col dc__gap-12 dc__overflow-auto ${!hideCodeEditor ? 'p-16' : ''}`}
        >
